...
namespace HugoCrossPoster.Tests
{
    public class ConvertFromMarkdownServiceTests
    {
        ...
        private readonly static Mock<ILogger<ConvertFromMarkdownService>> mockLogger = new Mock<ILogger<ConvertFromMarkdownService>>();
        private readonly ConvertFromMarkdownService markdownService = new ConvertFromMarkdownService(mockLogger.Object);
